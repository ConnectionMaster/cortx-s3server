...
@RunWith(PowerMockRunner.class)
 ...
 private
  ...
  @Test public void testSave() throws Exception {
    ...
    Mockito.doCallRealMethod().when(mockFileStore).save(
        Mockito.anyMap(), Mockito.anyObject(), Mockito.anyString());
    Map newDataMap = new HashMap();
    newDataMap.put("p4#acc3", mockObject);
    mockFileStore.save(newDataMap, null, "Policy");
  ...
  @Test public void testFind() throws DataAccessException {
    ...
    Assert.assertNotNull(mockFileStore.find("p1#acc1", null, "Policy"));
  }
  ...
  @Test public void testFindAll() throws DataAccessException {
    ...
    Assert.assertEquals(2,
                        mockFileStore.findAll("acc1", null, "Policy").size());
  }
